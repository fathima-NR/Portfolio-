...
export default function UberHealthProject() {
  const project = uberHealthProject;
    ...
    <article className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-14">
      ...
      <header className="mt-6 max-w-3xl">
        ...
        <div className="mt-5 flex flex-wrap gap-2 text-[11px] font-bold uppercase tracking-[0.12em] text-muted">
          <span className="rounded-full bg-white/80 px-3 py-1.5 ring-1 ring-line">{project.company}</span>
      ...
      <div className="mt-10 grid gap-4">
        <Section title="Project Overview">
          ...
          <p className="text-xs font-semibold uppercase tracking-[0.12em] text-muted">{project.note}</p>
        </Section>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Section title="Care Coordination Flow">
            <WorkflowDiagram steps={project.workflow} />
          </Section>
        </div>

        <Section title="Role-based Portals">
          <CardGrid blocks={project.portals} />
        </Section>

        <Section title="Key Business Workflows">
          <CardGrid blocks={project.businessWorkflows} />
        </Section>

        <Section title="Technical Highlights">
          <CardGrid blocks={project.technicalHighlights} />
        </Section>
